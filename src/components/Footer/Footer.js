    ...
    <footer className={`section footer ${hiddenFooter && 'footer_hidden'}`}>
      ...
      <div className='footer__container'>
        ...
        <ul className='footer__links'>
          <li><a href='https://practicum.yandex.ru/' rel="noreferrer" target="_blank"
          ...
          <li><a href='https://www.facebook.com/' rel="noreferrer" target="_blank" className='footer__link'>Facebook</a>
          </li>
        </ul>
      </div>
    </footer>
