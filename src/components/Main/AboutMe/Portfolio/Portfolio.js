  ...
  return(
    <div className='portfolio'>
      ...
      <ul className='portfolio__links'>
        <li className='portfolio__item'><a href='https://github.com/Anastasia-Belik/how-to-learn' rel="noreferrer" target="_blank" className='portfolio__link'>Статичный сайт <span>↗</span></a></li>
