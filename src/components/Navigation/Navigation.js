          ...
          <ul className='navigation__list'>
            <li className='navigation__item'>
              <Link to='/' onClick={props.onClose}
                    className={`navigation__link ${(location.pathname === '/') && 'navigation__link_border'}`}>
                Главная
              </Link>
            </li>
            <li className='navigation__item'>
              <Link to='/movies' onClick={props.onClose}
                    className={`navigation__link ${(location.pathname === '/movies') && 'navigation__link_border'}`}>
                Фильмы
              </Link>
            </li>
            <li className='navigation__item'>
              <Link to='/saved-movies' onClick={props.onClose}
                    className={`navigation__link ${(location.pathname === '/saved-movies') && 'navigation__link_border'}`}>
                Сохраненные фильмы
              </Link>
            </li>
          </ul>
